    ...
    <AddEditNote 
      ...
      <template v-slot:buttons>
        ...
        @click="handleSavedClicked"
          ...
          class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-green-400 hover:bg-green-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
        Save Note
        </button>
        <button
          @click="$router.back()"
